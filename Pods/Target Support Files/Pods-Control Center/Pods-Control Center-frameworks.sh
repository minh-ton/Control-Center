...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SpotifyAppleScript/SpotifyAppleScript.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iTunesAppleScript/iTunesAppleScript.framework"
fi
